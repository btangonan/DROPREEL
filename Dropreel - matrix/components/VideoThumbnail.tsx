  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-video bg-archive-light-gray">
        ...
        <div className="absolute inset-0 bg-archive-primary bg-opacity-15 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-center justify-center">
          <div className="text-background text-center drop-shadow-lg">
            <Play className="w-8 h-8 mx-auto mb-2" fill="currentColor" />
            <div className="text-xs font-mono">PLAY</div>
          </div>
        </div>
      </div>
    </div>
